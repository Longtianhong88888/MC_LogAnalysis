...
- soft_groups: `0`
- advisory_groups: `1`
- full_report: `/Users/user/Desktop/PY/MC_LogAnalysis/docs/usage_deck/validation/structure_precheck/history/structure_precheck_20260808_085901.json`

## Advisories

### `typography.font_size.outside_scale` × 14

检测到字号系统问题为 10pt×13, 54pt×1；当前未解析出 active role token，需先确认模板、语言和语义 role。

suggested_fix: 把该文本绑定到已有 typography token；确需新档位时先更新 theme_tokens 并记录语义用途。

actual_values: 10pt×13, 54pt×1
